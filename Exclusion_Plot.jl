...
x_values = test_df[!, 1] #values for m
...
scatter(x_relic, y_relic, title = "V model", minorgrid = true, minorticks = 10, legend=:bottomleft, xscale = :log, yscale = :log, xlabel = L"m_Q/GeV", ylabel = L"\frac{m_Q}{\Lambda}", labels="Overclosure")
