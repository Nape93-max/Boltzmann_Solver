...
annotate!(800, 1000, text(L"m_Q = 10^3"*" TeV", :black, :right, 12))
...
annotate!(200, 1E5, text(L"y_d = 0.001", :blue, :right, 9))
annotate!(200, 2E6, text(L"y_d = 0.1", :blue, :right, 9))
#annotate!(2000, 5, text(L"y_d = 0.1", :red, :right, 9))
annotate!(2000, 1000, text(L"y_d = 0.001", :red, :right, 9))
#annotate!(4000, 700000, text(L"y_d = 0.001", :red, :right, 9))
