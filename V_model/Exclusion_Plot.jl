...
plot!(x_BBN_line, y_BBN_line, fillrange = 1E-3*ones(size(x_BBN_line)), fillalpha = 0.35, c = 2, minorticks = 10,  minorgrid = true)
...
annotate!(1000, 10000, text(L"m_Q = 10^3"*" TeV", :black, :right, 12))
